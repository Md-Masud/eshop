                        ...
                        <ul>
                            ...
                            <li><a href="#">cart(3)</a>
                                <div class="card-hover  p-5">
                                    <div class="card-item clearfix position-relative mb-4">
                                        <img src="img/card-itemp1.jpg" class="img-fluid float-left" alt="">
                                        <div class="card-content float-left ml-3">
                                            <div class="card-text ">
                                                <p>Water Repellent Parka</p>
                                            </div>
                                            <h4 class="float-left new-price">$ 229.9 </h4>
                                            <h5 class="old-price pt-1 ml-1 float-left"> <del>$239.9</del> </h5>
                                        </div>
                                    ...
                                    <div class="total-price clearfix">
                                        ...
                                        <span class="float-right total-right">$ 689.8</span>
                                    </div>
          ...
          <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header  mb-3 text-center text-warning">
                            Dear <strong> MD Zubaer</strong>  .You have to give us product shipping info to complete your valuable order.if your billing info are same then just press on save shipping info button
                        </div>
                    </div>
          </div>
        </div>
